...
This repository contains the Wedge Litter Map app, which is a web app designed for the Wedge neighborhood in Minneapolis, MN. The app is intended for volunteers and residents of the Wedge to track litter reports across the neighborhood, as well as plan and track clean-up efforts.
